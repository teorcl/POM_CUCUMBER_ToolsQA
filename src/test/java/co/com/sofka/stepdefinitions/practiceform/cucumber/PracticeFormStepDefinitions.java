package co.com.sofka.stepdefinitions.practiceform.cucumber;
...
public class PracticeFormStepDefinitions extends WebUI {
    ...
    public void queElEmpleadoAdminSeEncuentraEnElSitioWebDeLosRegistrosDeLosEstudiantes() {
        try {
    ...
    public void elEmpleadoAdminIngresaLosDatosEnLosCamposObligatoriosYConfirmaLaAccion() {
    ...
    public void elSistemaDeberiaMostrarPorPantallaElRegistroDelEstudianteIngresado() {
