...
public class CommonActionsOnPages extends BaseSikulix {
    ...
    //==USO WEBELEMENT===
    //Functions
    public void doSubmit2(By webElement) throws IOException {
        driver.findElement(webElement).submit();
    }

    public void doSubmit2(WebElement webElement){
        webElement.submit();
    }
    ...
    public String getText2(WebElement webElement){
    ...
    public void clear2(By webElement){
        driver.findElement(webElement).clear();
    }

    public void clear2(WebElement webElement){
        webElement.clear();
    }

    public void clear2(By locator, CharSequence... keysToSend){
        webDriverExplicitWait.until(presenceOfElementLocated(locator)).sendKeys(keysToSend);
    }
    ...
    public void clickOn2(By locator){
        driver.findElement(locator).click();
    }

    public void clickOn2(WebElement webElement){
        webElement.click();
    }
